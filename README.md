...
```
git clone https://git.coding.net/wenxucheng/easier-react-native.git ./node_modules/easier-react-native
```

运行后，请在项目根目录下创建Manifest.js文件
...
将项目中所有需要exports的类都可注册在这里，如：

```
'use strict';

module.exports = {
	get R() {return require('./res')},
